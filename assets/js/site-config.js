window.SITE_CONFIG = {
  ...
  eventTagline:
    "La ceremonie organisee par la Collectivite Territoriale de Guyane pour valoriser les benevoles qui font vivre le sport.",
  ...
  heroPoster: "assets/images/nouveau header.webp",
  organizerLogo: "assets/images/logo asso.webp",
  organizerName: "Collectivite Territoriale de Guyane",
  organizerEmail: "contact@organisation-gala.fr",
  organizerEmailHref: "mailto:contact@organisation-gala.fr",
  organizerPhone: "+33 6 00 00 00 00",
  organizerPhoneHref: "tel:+33600000000",
